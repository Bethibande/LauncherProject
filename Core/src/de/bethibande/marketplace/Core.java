...
import de.bethibande.marketplace.moduleloader.IModuleManager;
import de.bethibande.marketplace.moduleloader.ModuleManager;
...
public class Core {
    ...
    public static IServiceBootstrap bootstrapInstance;
    public static IModuleManager moduleManager;

    public static void main(String[] args) {
        argumentParser = new ArgumentParser();
        argumentParser.parseArguments(args);
        if(!argumentParser.hasArgument("service")) System.exit(IServiceBootstrap.EXIT_NO_SERVICE_SPECIFIED);
        if(argumentParser.getArgumentValue("service").equalsIgnoreCase("server")) {
            ...
            bootstrapInstance.bootstrap(argumentParser);
        } else System.exit(IServiceBootstrap.EXIT_NO_SERVICE_SPECIFIED);
